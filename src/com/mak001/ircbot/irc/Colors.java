 ...
 * formatting to the lines, such as colors, boldness, underlining
 * and reverse text.
 *  <p>
 * The class contains static methods to remove colors and formatting
 ...
 * messages that use colors.  Also note that older IRC clients may be
 * unable to correctly display lines that contain colors and other
 * control characters.
 *  <p>
